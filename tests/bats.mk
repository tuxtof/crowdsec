...
bats-build: bats-environment
	...
	@cp cmd/crowdsec/crowdsec $(BIN_DIR)/
	@cp cmd/crowdsec-cli/cscli $(BIN_DIR)/
	@cp plugins/notifications/email/notification-email $(PLUGIN_DIR)/
	@cp plugins/notifications/http/notification-http $(PLUGIN_DIR)/
	@cp plugins/notifications/slack/notification-slack $(PLUGIN_DIR)/
	@cp plugins/notifications/splunk/notification-splunk $(PLUGIN_DIR)/
